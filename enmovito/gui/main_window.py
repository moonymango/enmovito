"""
Main window for the Enmovito application.

This module contains the MainWindow class, which is responsible for
the main application window and coordinating between components.
"""
...
class MainWindow(QMainWindow):
    ...
    This class is responsible for the main application window and
    coordinating between the control panel and visualization panel.
    """
    ...
    def apply_theme(self, theme_name="dark"):
        ...
        from enmovito.utils import resource_path
