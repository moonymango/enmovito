"""
Example script demonstrating how to use the Enmovito functionality
programmatically. This can be useful for automated analysis or integration into
...
def create_time_series_plot(df, time_column, parameters):
    ...
    fig.update_layout(
        ...
        width=900,
        title_text="Engine Data Time Series",
        showlegend=False,
    )
...
def main():
    ...
    # Example: Create a time series plot for engine RPM, MAP, and oil temp
